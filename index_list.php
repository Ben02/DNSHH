    <table class="table table-striped">
       <tbody>
		...
		<?php if (of_get_option('textdisplay') == 'text') { ?>
            <h3 class="h3"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a><span class="desc"><?php the_time('Y-m-d'); ?>  /  <?php echo getPostViews(get_the_ID()); ?> 次围观  /  <?php comments_popup_link('快抢沙发', '沙发被抢', '% 条评论'); ?></span></h3>
