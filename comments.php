...
$(function() {
	...
	<?php
		 ...
		 */
		if ( ! comments_open() ) : ?>
			<p class="nocomments"><h3>评论已关闭</h3></p>
		<?php else: ?>
		<div id="comment-box-wrapper">
			<div class="comment-box respond">
				...
				<h3 id="response"><b style="font-size:18px"> &gt; </b><?php comment_form_title('添加新评论', '评论 %s '); ?></h3>
				<form method="post" action="<?php echo site_url(); ?>/wp-comments-post.php" id="comment_form">
					...
					<div class="form-vertical">
						<?php if(is_user_logged_in()): ?>
							<div class="control-group">
								<div class="controls">
									...
									<label class="control-label" for="inputIcon">已经登录为 <a href="<?php echo get_edit_user_link() ?>"><?php echo $current_user->display_name ?></a> . <a href="<?php echo wp_logout_url( get_permalink() ); ?>">[退出]</a></p></label>
									</div>
								</div>
							</div>
						<?php else: ?>
							<div class="control-group">
								<div class="controls">
									...
									<input style="width: 141px;" placeholder="昵称（必填）" type="text" tabindex="2" name="author" value="<?php echo esc_attr( $commenter['comment_author'] ) ?>" />
									</div>
								</div>
							</div>
							<div class="control-group">
								<div class="controls">
									<div class="input-prepend">
										...
										<input style="width: 141px;" placeholder="邮箱（必填）" type="text" tabindex="3" name="email" value="<?php echo esc_attr(  $commenter['comment_author_email'] ) ?>" />
									</div>
								</div>
							</div>
							<div class="control-group">
						...
						<div class="control-group">
							<div class="controls">
								<div class="input-prepend">
									<input style="width: 180px;" type="submit" class="btn btn-primary" tabindex="5" value="提交评论（Ctrl+Enter）" id="misubmit"/>
