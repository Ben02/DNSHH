...
// post.js  Ajax评论翻页，index_ajax_navi.js  Ajax加载、翻页
jQuery(document).ready(function($) {
    var comments = $("#comments"), content=$("#content"),
        ajaxed = false;
    ...
    content.on("click", ".page-navigator li a", function(e){
        e.preventDefault();
        var _this = $(this),
            _thisP = _this.parent(),
            url = _this.attr("href");
    ...
    content.on("click", "h3 a", function(e){
        var myloadoriginal = this.text,
            url = $(this).attr("href");
        $(this).text('请稍等，正在努力加载中...');
        setTimeout(function() { 
            $(this).text(myloadoriginal);
            }, 2000);
    });
});
